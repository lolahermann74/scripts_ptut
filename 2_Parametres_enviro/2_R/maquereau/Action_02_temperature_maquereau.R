# ============================================================
# Extraction température (Copernicus NetCDF 4D: lon/lat/depth/time) sur captures maquereau
...
for (y in years) {
  ...
  out_file <- file.path(out_dir, sprintf("temperature_maquereau_%d.csv", y))
